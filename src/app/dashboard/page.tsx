  ...
  return (
    <div className="flex flex-col h-screen bg-background overflow-hidden" style={{ background: "#0B0F19" }}>
      ...
      <div className="flex-1 overflow-hidden p-1.5 pt-0 flex relative w-full">
        ...
        <div className="flex-1 min-w-[400px] h-full flex flex-col relative py-0 overflow-y-auto thick-scroll scroll-smooth z-10">
          <div className="flex flex-col min-h-full">
            ...
            <div className={`shrink-0 relative mb-1.5 transition-all duration-300 ${isMapMaximized ? "h-[calc(100vh-60px)]" : "h-[450px]"}`}>
            ...
            {!isMapMaximized && (
              <div className="shrink-0 mt-3 mb-4 h-auto min-h-[95px]">
                <BottomAnalytics />
              </div>
            )}
